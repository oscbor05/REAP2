...
def assess_property_complexity(revenue, expectation, amenities, projects):
    ...
    e_score = expectation  # Expectation input should directly map 1-3
    a_score = amenities  # Amenities input should directly map 1-3
    p_score = projects  # Projects input should directly map 1-3
